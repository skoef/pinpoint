...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "pinpoint.context_processors.version",
            ],
        },
    },
]
...
if os.environ.get("USE_S3", "false").lower() == "true":
    ...
    # Kept in step with dbsync._client(), which honours the same variable: both
    # should point at the same place when using an S3-compatible store.
